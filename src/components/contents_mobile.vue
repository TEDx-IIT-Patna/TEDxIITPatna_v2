<template>
    <!--  first part -->
    <img src="..\assets\hand_graphics.png" class="img1"/>
    <h1 class="heading">Togetherness</h1>
    <p class="content mx-3 justify-content-center">
...
The theme of Infinite Affinities speaks for togetherness. It signifies how people on the same journey reach their destination early if they work with harmony and integrity.
     ...
     <!--  second part -->
    <img src="..\assets\qestion_mark_1.png" class="img1 my-5"/>
...
This year TEDx IITPATNA  proudly presents it’s fourth edition. In this event, we shall highlight symbiosis and the team spirit that allows us to ascend to greater heights. Featuring diverse speakers from various walks of life, we hope to provide an enlightening experience to our community.    </p>
    
     <!--  Third part -->
    <img src="..\assets\x_1_img.png" class="img1 my-5"/>
<h1 class="heading my-2">TED<span class="letter_x">x</span> IIT Patna</h1>    <p class="content mx-3 justify-content-center">
...
Featuring diverse speakers from various walks of life, we hope to provide an enlightening experience to our community.    </p>
